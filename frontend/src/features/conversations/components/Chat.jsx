...
export function Chat({ chat }){
    ...
    const lastest_message_date = new Date(chat.latest_message.created_at);
    const latest_message_time = lastest_message_date.toLocaleTimeString([], { hour: '2-digit', minute: '2-digit' });
