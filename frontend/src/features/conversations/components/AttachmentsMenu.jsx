        ...
        <div className="fixed flex flex-col w-full bg-black/85 p-4 gap-2">
            ...
            <ul className="space-y-5 font-light">
                <li className={`${li_class} ${showPicker && 'px-2'}`} onClick={() => setShowPicker(!showPicker)}>
                    <img src="/brand/svgs/emoji.svg" loading="lazy" alt="emoji" width={32} className={`${img_class} rotate-6 group-hover:rotate-30`} />
                    Emojis
                </li>
                <li className={li_class}>
                    <img src="/brand/svgs/picture.svg" loading="lazy" alt="emoji" width={32} className={`${img_class} -rotate-6 group-hover:rotate-12`} />
                    Image
                </li>
                <li className={li_class}>
                    <img src="/brand/svgs/paper-clip.svg" loading="lazy" alt="emoji" width={32} className={`${img_class} -rotate-6 group-hover:rotate-12`} />
                    File
                </li>
            </ul>
        </div>
